const Contact = ({ showContact, setShowContact }) => {
  ...
  return (
    <>
      ...
      <div className={`max-w-[823px] w-full lg:rounded-lg mx-auto text-center fixed z-20 left-1/2 transform -translate-x-1/2 top-0 bottom-0 py-20 backdrop-blur-[10px] px-16 overflow-y-scroll custom-scrollbar ${showContact ? '' : 'hidden'}`}>
