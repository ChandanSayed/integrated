...
const Footer = ({ arabicLanguage, setShowContact }) => {
  ...
  return (
    <footer className="py-10 relative z-10 mt-32 bg-[#0f101b]">
      ...
      <a className={`block ml-auto cursor-pointer fixed bottom-6 bg-[#000000ff] rounded-full ${arabicLanguage ? 'left-6' : 'right-6'}`} href="https://api.whatsapp.com/send?phone=+13072227527">
