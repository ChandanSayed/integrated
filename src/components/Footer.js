...
const Footer = () => {
  ...
  return (
    <footer className="py-10 relative z-10 mt-32">
      ...
      <div className="fixed bottom-40 left-0 right-0 w-full mx-auto max-w-[1298px] max-lg:hidden h-0">
        <svg className="block ml-auto cursor-pointer" xmlns="http://www.w3.org/2000/svg" width="44" height="44" viewBox="0 0 44 44" fill="none">
