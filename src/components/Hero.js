...
const Hero = ({ arabicLanguage }) => {
  ...
  return (
    <div className="relative pt-[60px] lg:pt-[130px] pb-[110px] lg:pb-[190px] flex flex-col gap-5 lg:gap-[30px] items-center">
      <h1 className="font-GilroyBlack font-black text-white text-center text-5xl capitalize max-w-[326px] lg:max-w-[878px] mx-auto max-lg:text-2xl max-lg:leading-9">
