...
`
        ...
        <TwoColumnSection arabicLanguage={arabicLanguage} lineOneColor="text-yellow" lineTwoColor="text-white" imgSrc={eleven} lineOne={arabicLanguage ? 'CIO كخدمة' : 'CIO as a '} lineTwo={arabicLanguage ? ' (vCIO)' : 'service (vCIO)'} para={arabicLanguage ? `هل لاحظت يومًا وجود انفصال بين متطلبات عملك وما تقدمه تكنولوجيا المعلومات فعليًا؟ حتى أدنى اختلال يمكن أن يؤثر بشكل كبير على قدرتك على خدمة العملاء والحفاظ على مشاركة موظفيك وفعاليتهم. سد هذه الفجوة مع مدير تكنولوجيا المعلومات كخدمة في شركة iT IT، والذي يجمع بين مزيج قوي من الفطنة التجارية والخبرة الفنية لأي مؤسسة بأي حجم.` : `Ever noticed a disconnect between your business requirements and what IT actually delivers? Even the slightest misalignment can significantly impact your ability to service customers and keep your staff engaged and effective. Bridge that gap with iiT IT’s CIO as a Service, which combines a potent mix of business acumen with technical expertise for any sized organization.          `} classes={'lg:flex-reverse lg:flex-row lg:flex-row-reverse'} name="eleven" />
